...
namespace UdemyMinimalApi.Coupons.Endpoints
{
    public static class CouponEndpoints
    {
        public static void ConfigureCouponEndpoints(this WebApplication app)
        {
            ...
            app.MapPost("/api/coupon", async (ICouponRepository _couponRepo, IMapper _mapper, ILogger<Program> _logger, IValidator<CouponCreateDTO> _validation, [FromBody] CouponCreateDTO coupon_C_DTO) =>
            {
                APIResponse response = new()
                {
                    IsSuccess = false,
